resource "helm_release" "prometheus" {
  ...
  set {
    ...
    value = "(?i)(helium_.*|solana_.*|cluster_autoscaler.*|container_.*|kube_horizontalpodautoscaler.*|machine_.*|kube_pod_.*|kube_node_.*|kube_job_.*|kube_persistentvolume.*|kubelet_volume_.*|node_*|integrity_check)"
  }
